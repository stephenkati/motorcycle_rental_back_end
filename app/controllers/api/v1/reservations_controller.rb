class Api::V1::ReservationsController < ApplicationController
  ...
  def create
    ...
    if @reservation.save
      ...
      render json: { status: 'Error', message: 'Failed to create reservation', errors: @reservation.errors },
  ...
  def update
    ...
    if @reservation.update(reservation_params)
      ...
      render json: { status: 'Error', message: 'Failed to update reservation', errors: @reservation.errors },
             status: :unprocessable_entity
    end
  end
